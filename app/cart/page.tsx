        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-4">
            {cart.map((item) => (
              <div key={item.id} className="bg-white rounded-2xl p-4 flex items-center gap-4 shadow-sm">
                ...
                <button onClick={() => removeFromCart(item.id)} className="p-2 hover:bg-red-50 rounded-xl transition">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm h-fit">
            ...
            <div className="space-y-3 mb-4">
              ...
              {shipping > 0 && (
                <p className="text-xs text-gray-500">Free shipping on orders over ₦20,000</p>
              )}
            </div>
